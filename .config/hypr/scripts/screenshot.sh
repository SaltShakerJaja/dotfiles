...
# Screenshot Filename
source ~/.config/juan/settings/screenshot-filename.sh

# Screenshot Folder
source ~/.config/juan/settings/screenshot-folder.sh

# Screenshot Editor
export GRIMBLAST_EDITOR="$(cat ~/.config/juan/settings/screenshot-editor.sh)"
